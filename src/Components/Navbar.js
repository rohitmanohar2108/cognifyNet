...
import { faHome, faTachometerAlt, faBriefcase, faUsers, faChalkboardTeacher, faHeart, faNetworkWired, faUser } from '@fortawesome/free-solid-svg-icons'; // Import faUser for the Profile icon
